...
pub fn day_14_main() -> Answer{
    ...
    for _ in 0..10{
        ...
        for i in 0..current_string.len()-1{
            new_line += &format!("{}{}",&current_string[i..i+1],mappings.get(&current_string[i..i+2]).unwrap());
        }
    ...
    Answer{day:14, part_1:part_1.to_string(), part_2:part_2.to_string(), duration:duration}
}
